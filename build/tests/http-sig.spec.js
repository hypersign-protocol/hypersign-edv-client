...
var keyResolverEd25519 = function () { return __awaiter(void 0, void 0, void 0, function () {
...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var keypair, hsCipher, BASE_URL, edvId, url, signedHeader;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, key_spec_1.Ed25519Keypair)()];
                case 1:
                    keypair = _a.sent();
                    hsCipher = new hsZCapHttpSig_1.default({ keyAgreementKey: keypair });
                    BASE_URL = 'http://localhost:3001';
                    edvId = '62473c97-283c-4369-832e-587778255611';
                    url = "".concat(BASE_URL, "/api/v1/edvs/").concat(edvId, "/docs");
                    return [4 /*yield*/, hsCipher.signHTTP({
                            url: url,
                            method: 'POST',
                            headers: {
