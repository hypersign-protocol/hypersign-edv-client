...
function testwithed25519() {
    return __awaiter(this, void 0, void 0, function () {
        var keyAgreementKey, hsCipher, messsage, jwe, plainobject;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, key_spec_1.Ed25519Keypair)(key_spec_1.authenticationKey)];
                case 1:
                    keyAgreementKey = _a.sent();
                    console.log(keyAgreementKey);
                    hsCipher = new index_1.HypersignCipher({
                        keyResolver: key_spec_1.hypersignDIDKeyResolverForEd25519KeyPair,
                        keyAgreementKey: keyAgreementKey
                    });
                    messsage = { 'foo': 'bar12312' };
                    return [4 /*yield*/, hsCipher.encryptObject({ plainObject: messsage })];
                case 2:
                    jwe = _a.sent();
                    console.log(jwe);
                    return [4 /*yield*/, hsCipher.decryptObject({ jwe: jwe })];
                case 3:
                    plainobject = _a.sent();
...
function testwithex25519() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, key_spec_1.X25519KeyAgreementKeyPair)(key_spec_1.authenticationKey)
