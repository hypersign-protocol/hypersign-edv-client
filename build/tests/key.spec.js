...
export function Ed25519Keypair(key = authenticationKey) {
    return __awaiter(this, void 0, void 0, function* () {
        const ed25519KeyPair = yield Ed25519VerificationKey2020.generate(Object.assign({}, key));
        return ed25519KeyPair;
    });
}
export function X25519KeyAgreementKeyPair(key = authenticationKey) {
    return __awaiter(this, void 0, void 0, function* () {
...
export const hypersignDIDKeyResolverForEd25519KeyPair = ({ id }) => __awaiter(void 0, void 0, void 0, function* () {
    id;
...
export const hypersignDIDKeyResolverForX25519KeyPair = ({ id }) => __awaiter(void 0, void 0, void 0, function* () {
    id;
    // TODO: The id passed here is a verificationmethodId, we can query the DID document to fetch ed25519 authentication keys
    // Then convert ed25519 pair into X25519KeyAgreementKey2020 , so let's mock it. 
    // say we get this verificationMEthod after quering from our DID document
